...
class User(AbstractBaseUser):
    ...
    is_staff = models.BooleanField(default=False)  # a user who can access the admin site
    is_superuser = models.BooleanField(default=False)  # a superuser who has all permissions
